...
class GoogleMovieShowtimes:
    '''
    GoogleMovieShowtimes class - used for getting response from www.google.com/movies
    Constructor for GoogleMovieShowtimes class.

    Parameters:
        near (optional)     - (string) valid name of the location (city)
        mid	(optional)      - (string) valid movie ID. Can be taken from www.google.com/movies
        tid	(optional)      -	(string) valid theater ID. Can be taken from www.google.com/movies
    '''
    ...
    def parse(self):
        '''Function for parsing the response and getting all the important data as a huge dictionary object.
